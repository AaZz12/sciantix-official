...
void FiguresOfMerit()
{
	...
	if (sciantix_variable[sv["Xe133 produced"]].getFinalValue() - sciantix_variable[sv["Xe133 decayed"]].getFinalValue() > 0.0)
		sciantix_variable[sv["Xe133 R/B"]].setFinalValue(
			sciantix_variable[sv["Xe133 released"]].getFinalValue() / (sciantix_variable[sv["Xe133 produced"]].getFinalValue() - sciantix_variable[sv["Xe133 decayed"]].getFinalValue())
		);
	else
	...
	if (sciantix_variable[sv["Kr85m produced"]].getFinalValue() - sciantix_variable[sv["Kr85m decayed"]].getFinalValue() > 0.0)
		sciantix_variable[sv["Kr85m R/B"]].setFinalValue(
			sciantix_variable[sv["Kr85m released"]].getFinalValue() / (sciantix_variable[sv["Kr85m produced"]].getFinalValue() - sciantix_variable[sv["Kr85m decayed"]].getFinalValue())
		);
	else
	...
	if (sciantix_variable[sv["He produced"]].getFinalValue() > 0.0)
		sciantix_variable[sv["He fractional release"]].setFinalValue(
			sciantix_variable[sv["He released"]].getFinalValue() / sciantix_variable[sv["He produced"]].getFinalValue()
		);
	else
	...
	if(sciantix_variable[sv["Intergranular vacancies per bubble"]].getFinalValue())
		sciantix_variable[sv["Intergranular bubble pressure"]].setFinalValue(
			1e-6 * boltzmann_constant * history_variable[hv["Temperature"]].getFinalValue() *

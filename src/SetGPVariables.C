...
void SetGPVariables()
{
    ...
    if ((sciantix_variable[sv["Intergranular fractional coverage"]].getFinalValue()) > 0) // to be changed
    {
        std::ifstream input_fileU1("UpdatedCorrelation_VentedFraction.txt");
        std::ifstream input_fileS1("StandardDeviation_VentedFraction.txt");

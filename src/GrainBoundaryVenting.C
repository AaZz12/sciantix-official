...
double openPorosity(double fabrication_porosity)
{
    switch (int(input_variable[iv["iGrainBoundaryVenting"]].getValue()))
    {
        case 0: case 1:
            /**
             * The open porosity is not of use
             * 
             * case 0: athermal release not considered
             * case 1: athermal release with numerical vented fraction depending on the fractional coverage
            */
        ...
        case 3:
        {
            /**
             * @brief This function evaluates the open porosity according to the value of fabrication porosity 
             * Data from **Claisse et al. Journal of Nuclear Materials 466 (2015) 351-356** are refitted with a sigmoid function
             * 
             * 
            */
            if (fabrication_porosity <= 1.0)

...
void GrainBoundaryVenting()
{
    ...
    case 1:
    {
		...
		// sciantix_variable[sv["Intergranular venting probability"]].setFinalValue(model[sm["Grain-boundary venting"]].getParameter().at(0));
    ...
    {
        /// @brief
        /// Athermal fission gas release

        // sciantix_variable[sv["Open porosity"]].setFinalValue(openPorosity(0.06));
        double fabrication_porosity = 0.06;
        double open_porosity = openPorosity(fabrication_porosity);
        ...
        reference = "Athermal release / venting.";
        break;
    }
...
{
    /**
     * @brief Athermal venting favtor = 
     * @ref * 
     * 
     * @author G. Zullo, A. Pagani
     * 
     */
    switch (int(input_variable[iv["iGrainBoundaryVenting"]].getValue()))
    {
...
{
    /*
     * @brief This function evaluates the open porosity according to the value of fabrication porosity 

...
void Initialization()
{
	...
	int iteration(0), iteration_max(25), n(0), np1(1), n_modes(40), k(0), K(25);
	...
	for (k = 0; k < K; ++k)
	{
		...
		case 24: initial_condition = Sciantix_variables[115]; break;  // I133 in grain
		case 25: initial_condition = Sciantix_variables[116]; break;  // I133 in grain - solution
		case 26: initial_condition = Sciantix_variables[117]; break;  // I133 in grain - bubbles
